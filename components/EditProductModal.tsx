...
const EditProductModal = ({
  ...
  const onSubmit: SubmitHandler<FormType> = async (data) => {
    ...
    if (selectedImage) newProduct.image = selectedImage;

    await updateDoc(doc(firestore, "products", product.id), newProduct);
    ...
    if (!selectedImage && img != imageUrl) {
      ...
      formData.append("obj", JSON.stringify({ productId: product.id }));
