        ...
        value: function connect() {
          ...
          return new Promise(function (resolve, reject) {
            ...
            request.onerror = function (event) {
              var error = new Error(
                "Database error: ".concat(event.target.error),
              );
              reject(error);
            };
          });
...
self.PusherPushNotifications = {
  ...
  _hasVisibleClient: function _hasVisibleClient() {
    return self.PusherPushNotifications._getVisibleClient().then(
      function (client) {
  ...
  _hasFocusedClient: function _hasFocusedClient() {
    return self.PusherPushNotifications._getFocusedClient().then(
      function (client) {
        return client !== undefined;
      },
    );
              ...
              switch ((_context.prev = _context.next)) {
                case 0:
                  (eventType = _ref.eventType),
                    (pusherMetadata = _ref.pusherMetadata);
                  (instanceId = pusherMetadata.instanceId),
                    (publishId = pusherMetadata.publishId),
                    (hasDisplayableContent =
                      pusherMetadata.hasDisplayableContent),
